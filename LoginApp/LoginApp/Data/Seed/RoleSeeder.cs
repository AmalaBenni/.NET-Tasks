...
namespace EmployeeMgmt.Data.Seed
{
    public static class RoleSeeder
    {
        public static async Task SeedRolesAsync(IServiceProvider serviceProvider)
        {
            ...
            await EnsureUserAsync(userManager, logger, "admin@LoginApp.com", "Admin@123", "Admin");
            await EnsureUserAsync(userManager, logger, "manager@LoginApp.com", "Manager@123", "Manager");
            await EnsureUserAsync(userManager, logger, "employee@LoginApp.com", "Employee@123", "Employee");
        }
